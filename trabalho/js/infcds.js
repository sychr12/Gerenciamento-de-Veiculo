// Load vehicle details from localStorage
...
if (veiculoCadastrado) {
    detalhesVeiculo.innerHTML = `
        <p><strong>Funcionário:</strong> ${veiculoCadastrado.Fucionario}</p>
...
// Load vehicle details from URL parameters
